...
const DebtForm = ({ onSubmit, accounts = [], onCancel, initialData }) => {
  ...
  const handleSubmit = () => {
    ...
    if (type === 'one-time') {
      newDebt.dueDate = dueDate.toISOString();
    } else if (type === 'recurring') {
      newDebt.recurringFrequency = recurringFrequency;
      if (recurringFrequency === 'weekly') {
        newDebt.recurringDay = recurringDay;
      } else if (recurringFrequency === 'monthly') {
        newDebt.recurringDayOfMonth = recurringDay;
      } else if (recurringFrequency === 'yearly') {
        newDebt.recurringMonth = recurringMonth;
        newDebt.recurringDayOfMonth = recurringDay;
      }
    }
